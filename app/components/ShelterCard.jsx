...
export default function ShelterCard({ shelter, urgent }) {
  ...
  return (
    ...
    >
      ...
      <p className="text-sm text-gray-400 mt-3">Tel: {shelter.phone}</p>
      ...
      <div className="mt-5 flex flex-col gap-3">
        ...
        {(shelter.alias || shelter.cvu || shelter.mp_link) && (
          <div className="bg-gray-50 border rounded-2xl p-4">
            <p className="font-bold text-gray-800 mb-3">❤️ Ayudar al refugio</p>

            {shelter.alias && (
              <div className="mb-2">
                <p className="text-xs text-gray-500">Alias</p>

                <p className="font-mono text-sm break-all">{shelter.alias}</p>
              </div>
            )}
            ...
            {shelter.cvu && (
              <div className="mb-2">
                ...
                <p className="font-mono text-sm break-all">{shelter.cvu}</p>
              </div>
            )}
