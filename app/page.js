...
`
  ...
  const filteredShelters = shelters
    ...
    .sort((a, b) => {
      ...
      if (urgent) {
        return Number(b.has_capacity) - Number(a.has_capacity) || bCity - aCity
      }
      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="mb-12 text-center">
          ...
          <p className="text-xl text-gray-600 max-w-2xl mx-auto">
            Encontrá mascotas en adopción, publicá mascotas perdidas, ayudá a
            reunir familias y conectate con refugios de todo el país.
          </p>
        ...
        {!loading && filteredShelters.length > 0 && (
          <div className="grid gap-6">
            {filteredShelters.map((shelter) => (
              <ShelterCard key={shelter.id} shelter={shelter} urgent={urgent} />
            ))}
          </div>
        )}
        ...
        <div className="mt-12 bg-blue-50 border border-blue-200 rounded-lg p-6">
          <p className="text-sm text-gray-700">
            <strong>ℹ️ Nota:</strong> Esta información es orientativa. Contactá
            siempre al refugio antes de trasladar una mascota.
          </p>
        </div>
      </div>
    </main>
